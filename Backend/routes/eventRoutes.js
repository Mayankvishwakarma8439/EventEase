...
import { createEvent, deleteEvent, getEventById, getEvents, getMyEvents, registerEvent, unregisterEvent, updateEvent } from "../controllers/eventController.js";
...
router.post("/unregister-event",authMiddleware,unregisterEvent)
